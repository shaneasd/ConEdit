...
namespace Clandestine
{
    ...
    {
        internal static bool IsAIBark(ID<NodeTypeTemp> type, IErrorCheckerUtilities utils)
        {
            return utils.GetCategory(type) == Guid.Parse("5ee1cde6-a1d4-4fe5-9607-b782f324da4e");
        }

        internal static bool IsStartNode(ID<NodeTypeTemp> type, IErrorCheckerUtilities utils)
        {
