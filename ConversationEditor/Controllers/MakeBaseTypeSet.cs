...
namespace ConversationEditor
{
    internal static class BaseTypeSet
    {
        ...
        public static TypeSet Make()
        {
            ...
            result.AddOther(BaseTypeString.ParameterType, "String", (name, id, val) => new StringParameter(name, id, BaseTypeString.ParameterType, val));
            ...
            result.AddOther(BaseTypeAudio.PARAMETER_TYPE, "Audio", (name, id, val) => new AudioParameter(name, id, BaseTypeAudio.PARAMETER_TYPE));
            return result;
        }
