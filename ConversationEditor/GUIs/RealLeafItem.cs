...
namespace ConversationEditor
{
    public partial class ProjectExplorer
    {
            ...
            where TInterface : ISaveableFileProvider
        {
            ...
            public RealLeafItem(Func<RectangleF> area, TConcrete item, Bitmap icon, IProject project, ContainerItem parent, Func<VisibilityFilter, bool> filter, Func<Matrix> toControlTransform)
