...
{
    public partial class ParameterEditorCustomizer1 : Form
    {
        ...
        public ParameterEditorCustomizer1()
        {
            InitializeComponent();
        ...
        {
            m_selectedType = dataGridView1.Rows[rowIndex].Cells[0].Value as ID<ParameterType>;
            treeView1.Select();
