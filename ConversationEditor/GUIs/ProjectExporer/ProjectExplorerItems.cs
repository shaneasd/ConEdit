        ...
        public abstract class Item
        {
            ...
            public void Draw(Graphics g, VisibilityFilter filter)
            {
                ...
                if (m_textBox == null)
                {
                    ...
                    TextRenderer.DrawText(g, Text, SystemFonts.MessageBoxFont, TextArea.Location.Plus(MyTextBox.BORDER_SIZE, MyTextBox.BORDER_SIZE).Round(), ColorScheme.Foreground, ColorScheme.Background, TextFormatFlags.TextBoxControl | TextFormatFlags.NoPadding | TextFormatFlags.NoPrefix);
