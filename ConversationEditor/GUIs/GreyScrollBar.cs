...
namespace ConversationEditor
{
    public partial class GreyScrollBar : UserControl
    {
        ...
        static GreyScrollBar()
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarUp.png"))
                ScrollbarUpIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarUpPressed.png"))
                ScrollbarUpPressedIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarBackgroundVertical.png"))
                ScrollbarBackgroundVerticalIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarMiddle.png"))
                ScrollbarMiddleIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarMiddlePressed.png"))
                ScrollbarMiddlePressedIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarTop.png"))
                ScrollbarTopIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarTopPressed.png"))
                ScrollbarTopPressedIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarBottom.png"))
                ScrollbarBottomIcon = new Bitmap(stream);
            using (Stream stream = assembly.GetManifestResourceStream("ConversationEditor.Resources.ScrollbarBottomPressed.png"))
        ...
        public GreyScrollBar()
        {
            ...
            Action CreateButtons = () =>
                {
                    TopButton = new Button(new Point(0, 0), !Horizontal ? Button.Direction.Up : Button.Direction.Left, () => m_state);
                    var location = Horizontal ? new Point(Width - BUTTON_SIZE, 0) : new Point(0, Height - BUTTON_SIZE);
                    BottomButton = new Button(location, !Horizontal ? Button.Direction.Down : Button.Direction.Right, () => m_state);
                };
            CreateButtons();
        ...
        private class Button
        {
            ...
            public Button(Point location, Direction direction, Func<StateEnum> state)
            {
            ...
            public void Draw(Graphics g, bool pushed)
            {
                ...
                g.Transform = m;
                using (var brush = new SolidBrush(ColorScheme.FormBackground))
