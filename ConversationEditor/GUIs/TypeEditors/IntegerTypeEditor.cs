...
{
    public partial class IntegerTypeEditor : UserControl
    {
        MyTextBox m_name;
        MyNumericUpDown<int> m_min;
        MyNumericUpDown<int> m_max;
        MyNumericUpDown<int> m_default;
        float m_textHeight;
        float m_textWidth;
        float m_minLabelWidth;
        float m_maxLabelWidth;
        float m_defaultLabelWidth;
        string TEXT = "Integer Type";
        ...
        public IntegerData Data
        {
            ...
            set
            {
                ...
                m_min.Value = value.Min.GetValueOrDefault(int.MinValue);
                m_max.Value = value.Max.GetValueOrDefault(int.MaxValue);
                m_default.Value = value.Default.GetValueOrDefault(0.Clamp(int.MinValue, int.MaxValue));
            }
        }
