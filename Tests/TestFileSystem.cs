        ...
        {
            {
                ...
                Assert.True(DirectoryEqualityComparer.SameDir(new DirectoryInfo(@"C:\a\b\c\d\e\f"), path.ElementAt(5)));
            }
...

            {
                ...
                Assert.True(DirectoryEqualityComparer.SameDir(anscestor, FileSystem.PathToFrom(anscestor, anscestor).Single()));
            }
